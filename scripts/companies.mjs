...
export const manualCompanies = [
  ...
  ['USAA', 'Insurance', 'https://www.usaajobs.com', 'Technology Development Program'],
  ...
  ['Cigna', 'Healthcare', 'https://jobs.cigna.com', 'Technology Rotational Program'],
  ...
  ['AT&T', 'Telecom', 'https://www.att.jobs', 'Technology Development Program'],
